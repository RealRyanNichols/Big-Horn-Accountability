...
export const records: LedgerRecord[] = [
  ...
  {
    id: "BHA-2003-003",
    slug: "marlin-yarlott-seized-rifle-conviction",
    title: "Crow Agency BIA investigator pleaded guilty after keeping seized rifle evidence",
    date: "2003-03-31",
    dateQualifier: "Disposition reported during the October 2002–March 2003 OIG period; exact sentencing date not stated",
    year: 2003,
    place: "Crow Agency / Bureau of Indian Affairs",
    institution: "Bureau of Indian Affairs / Crow Agency Law Enforcement Services",
    officialType: "Federal law enforcement",
    theme: "Law enforcement & courts",
    people: ["Marlin D. Yarlott"],
    status: "Criminal conviction",
    publicationState: "Reviewed",
    summary:
      "The Interior Inspector General reported that former BIA criminal investigator Marlin D. Yarlott pleaded guilty after taking a rifle that had been seized as evidence and keeping it for personal use. The report says he resigned and received two years of probation, 192 hours of community service, and a $1,250 fine.",
    whatItEstablishes:
      "An official Inspector General report establishes the guilty plea, the evidence-related conduct described by the agency, resignation, and reported sentence.",
    whatItDoesNotEstablish:
      "The report does not supply an exact plea or sentencing date, and one adjudicated matter does not establish a broader pattern or wrongdoing by unrelated BIA or tribal personnel.",
    tags: ["BIA", "law enforcement", "evidence", "guilty plea", "Inspector General"],
    sources: [
      {
        label: "Department of the Interior OIG — April 2003 Semiannual Report",
        url: "https://www.doioig.gov/sites/default/files/2021-migration/Semiannual-APR2003SAR.pdf",
        kind: "Inspector General report",
        checkedOn: "2026-07-15",
        note: "The report identifies the disposition within its October 2002–March 2003 reporting period but does not state the exact sentencing day.",
      },
    ],
  },
  {
    id: "BHA-1990-001",
    slug: "theodore-hogan-federal-conviction",
    title: "Former elected Crow secretary and housing executive was convicted of conspiracy, bank fraud, and a false statement",
    date: "1990-12-31",
    dateQualifier: "Conviction year; exact conviction and sentencing dates not stated in the reviewed OIG report",
    year: 1990,
    place: "Crow Reservation / Montana",
    institution: "Crow Tribal Government / Crow Tribal Housing Authority",
    officialType: "Tribal executive",
    theme: "Public money & audits",
    people: ["Theodore J. Hogan"],
    status: "Criminal conviction",
    publicationState: "Reviewed",
    summary:
      "A Department of the Interior Inspector General report states that former elected Crow Tribe secretary and former Crow Tribal Housing Authority executive director Theodore J. Hogan was convicted in 1990 of conspiracy, bank fraud, and making a false statement on a bank-loan application. The report states that he received 24 months of incarceration and $35,100 in restitution to the Crow Tribe.",
    whatItEstablishes:
      "The official OIG report establishes the 1990 convictions, former public roles, incarceration term, and restitution amount it attributes to Hogan.",
    whatItDoesNotEstablish:
      "The report also mentions a separate 2006 indictment, but no final disposition for that later charge was located; this entry does not present that allegation as a conviction or infer present conduct.",
    tags: ["Crow Tribe", "housing authority", "bank fraud", "conspiracy", "restitution"],
    sources: [
      {
        label: "Department of the Interior OIG — October 2006 Semiannual Report",
        url: "https://www.doioig.gov/sites/default/files/2021-migration/Semiannual-OCT2006SAR.pdf",
        kind: "Inspector General report",
        checkedOn: "2026-07-15",
        note: "The 1990 adjudicated outcome is separated here from the report's description of a later indictment for which no final disposition was located.",
      },
    ],
  },
  {
    id: "BHA-2025-002",
    slug: "big-horn-county-fy2023-single-audit",
    title: "Big Horn County’s FY2023 Single Audit recorded two repeat federal compliance and control findings",
    date: "2025-03-25",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Big Horn County / Federal Audit Clearinghouse",
    institution: "Big Horn County government / Federal Audit Clearinghouse",
    officialType: "Federal Single Audit",
    theme: "Public money & audits",
    people: [],
    status: "Audit finding",
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2023-06-GSAFAC-0000031966 records $2,303,622 in federal expenditures and two repeat findings: missing compliant procurement and suspension/debarment verification procedures, and insufficient segregation of duties. The County agreed with both findings.",
    whatItEstablishes:
      "The official federal dataset establishes the audit classifications, the two repeat finding references, the County’s recorded agreement, and the federal expenditure total for the audit period.",
    whatItDoesNotEstablish:
      "Control and compliance findings do not by themselves establish fraud, theft, a loss amount, or personal misconduct by any commissioner, employee, or corrective-action contact.",
    tags: ["Big Horn County", "Single Audit", "procurement", "debarment", "segregation of duties", "repeat finding"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2025 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2023-06-GSAFAC-0000031966.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 findings data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2023-06-GSAFAC-0000031966; see findings 2023-014 and 2023-015.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 finding narratives CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings_text.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
      },
      {
  ...
  {
    id: "BHA-2025-003",
    slug: "big-horn-county-fy2024-single-audit",
    title: "Big Horn County’s FY2024 Single Audit recorded two repeat findings and a new subrecipient-monitoring finding",
    date: "2025-04-01",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Big Horn County / Federal Audit Clearinghouse",
    ...
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2024-06-GSAFAC-0000360896 records $2,509,826 in federal expenditures, material weakness and material noncompliance classifications, repeat findings for segregation of duties and procurement/suspension-debarment procedures, and a new subrecipient-monitoring finding. No questioned costs were reported for the three findings.",
    whatItEstablishes:
      "The official federal dataset establishes the listed audit classifications, repeat-finding links, new monitoring finding, corrective-action responses, and reported expenditure total.",
    whatItDoesNotEstablish:
      "The findings do not establish fraud or personal misconduct. The monitoring narrative contains an apparent internal wording inconsistency—one sentence says the County ‘did perform’ monitoring while the surrounding finding says it did not comply—so this entry does not resolve that contradiction.",
    tags: ["Big Horn County", "Single Audit", "material weakness", "material noncompliance", "subrecipient monitoring", "repeat finding"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2025 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2024-06-GSAFAC-0000360896.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 findings data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2024-06-GSAFAC-0000360896; see findings 2024-017 through 2024-019.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 finding narratives CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings_text.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Finding 2024-019 contains the internal wording inconsistency preserved in this entry's limitation.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 corrective-action plans CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-corrective_action_plans.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
      },
    ],
  ...
  {
    id: "BHA-2025-004",
    slug: "city-of-hardin-fy2024-audit-disclaimer",
    title: "Hardin’s FY2024 audit disclaimed only on its aggregate component unit and recorded five repeat financial-statement findings",
    date: "2025-06-11",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Hardin / Federal Audit Clearinghouse",
    institution: "City of Hardin / Federal Audit Clearinghouse",
    officialType: "Federal Single Audit",
    theme: "Public money & audits",
    people: [],
    status: "Audit finding",
    publicationState: "Reviewed",
    summary:
      "The complete audit for FAC report 2024-06-GSAFAC-0000371830 gives unmodified opinions for the City’s governmental activities, business-type activities, named major funds, and remaining fund information, while disclaiming only on the aggregate discretely presented component unit because Two Rivers Authority information was omitted and could not be audited. Five repeat financial-statement findings address a disputed TRA back-pay claim, a missing fire-relief pension valuation, unavailable TRA financial records, $1,601,677 in deposits not fully insured or collateralized, and TIF bond arrears of $8.8 million principal plus $6,094,221 interest.",
    whatItEstablishes:
      "The official audit establishes the limited component-unit disclaimer; the five repeat accounting, reporting, control, and bond-compliance findings; the auditor’s stated dollar amounts and limitations; and management’s recorded corrective-action responses. It reports no federal-award findings or questioned costs.",
    whatItDoesNotEstablish:
      "The disclaimer does not apply to every City opinion unit. The audit says the back-pay claim could not be validated, says the City complied with the cited Montana deposit statute despite recommending full protection, and does not find fraud, stolen or missing money, criminal conduct, or personal responsibility by any listed officeholder.",
    nextVerification: "Track the stated FY2025 through FY2027 corrective-action targets and compare the next complete audit for resolved, repeated, or newly quantified conditions.",
    tags: ["City of Hardin", "Two Rivers Authority", "TIF bonds", "disclaimer of opinion", "financial reporting", "pledged securities", "repeat finding"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — complete City of Hardin FY2024 audit",
        url: "https://app.fac.gov/dissemination/report/pdf/2024-06-GSAFAC-0000371830",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "See the opinion pages and findings 2024-001 through 2024-005, including management responses, on audit pages 85–93.",
      },
      {
        label: "Federal Audit Clearinghouse — report summary",
        url: "https://app.fac.gov/dissemination/summary/2024-06-GSAFAC-0000371830",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
      },
      {
        ...
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2024-06-GSAFAC-0000371830.",
      },
    ],
  },
  {
    id: "BHA-2025-005",
    slug: "northern-cheyenne-fy2024-single-audit",
    title: "Northern Cheyenne Tribe’s FY2024 Single Audit recorded modified opinions and material noncompliance",
    date: "2025-06-27",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Northern Cheyenne Reservation / Federal Audit Clearinghouse",
    institution: "Northern Cheyenne Tribal Government / Federal Audit Clearinghouse",
    officialType: "Federal Single Audit",
    theme: "Public money & audits",
    people: [],
    status: "Audit finding",
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2024-09-GSAFAC-0000372423 records $44,847,692 in federal expenditures, qualified and unmodified opinions, material noncompliance, and two findings involving the Indian Self-Determination/Tribal Self-Governance cluster. One finding repeats a 2023 reference, and no questioned costs are reported.",
    whatItEstablishes:
      "The official federal dataset establishes the reported expenditure total, opinion and compliance classifications, two finding references, program cluster, repeat indicator, and absence of questioned-cost flags.",
    whatItDoesNotEstablish:
      "No public finding narrative is available. The general row says no material weakness while the finding rows mark the findings as material weaknesses; this entry preserves that metadata inconsistency and does not infer which field controls, personal blame, fraud, or loss.",
    nextVerification: "Obtain the complete audit package and corrective-action plan to resolve the public metadata discrepancy and describe the underlying conditions accurately.",
    tags: ["Northern Cheyenne Tribe", "Single Audit", "material noncompliance", "modified opinion", "metadata discrepancy"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2025 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2024-09-GSAFAC-0000372423.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 findings data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2024-09-GSAFAC-0000372423; the material-weakness flags conflict with the general row.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 federal awards CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-federal_awards.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
      },
    ],
  ...
  {
    id: "BHA-2025-006",
    slug: "crow-tribe-fy2022-single-audit",
    title: "Crow Tribe’s FY2022 Single Audit recorded a disclaimer, material weaknesses, and ten findings",
    date: "2025-06-23",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Crow Reservation / Federal Audit Clearinghouse",
    ...
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2022-09-GSAFAC-0000372415 records $40,673,128 in federal expenditures, a disclaimer of opinion, material weakness, control-deficiency, and material-noncompliance classifications, and ten unique findings numbered 2022-003 through 2022-012. Several repeat FY2021 findings, and three carry questioned-cost flags.",
    whatItEstablishes:
      "The official federal dataset establishes the audit classifications, expenditure total, ten finding references, repeat indicators, and questioned-cost flags in the public tables.",
    whatItDoesNotEstablish:
      "The public data does not provide narrative findings or questioned-cost amounts. A questioned-cost flag is not proof of theft or fraud, and the institutional record does not assign personal misconduct to any leader or employee.",
    nextVerification: "Obtain the full audit package, finding narratives, questioned-cost amounts, and corrective-action plan, then compare FY2023 and later reports for resolution or recurrence.",
    tags: ["Crow Tribe", "Single Audit", "disclaimer of opinion", "material weakness", "material noncompliance", "questioned costs"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2025 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2022-09-GSAFAC-0000372415.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 findings data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2022-09-GSAFAC-0000372415; ten unique finding references appear.",
      },
    ],
  },
  {
    id: "BHA-2025-007",
    slug: "lodge-grass-school-fy2023-late-reporting",
    title: "Lodge Grass School District’s FY2023 Single Audit recorded a repeat late-reporting finding",
    date: "2025-01-03",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2025,
    place: "Lodge Grass / Federal Audit Clearinghouse",
    institution: "Lodge Grass School District / Federal Audit Clearinghouse",
    officialType: "Public education",
    theme: "Public money & audits",
    people: [],
    status: "Audit finding",
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2023-06-GSAFAC-0000345755 records $6,464,434 in federal expenditures and finding 2023-002, which says the audit was not submitted by the March 31, 2024 deadline and repeats finding 2022-005. The auditor attributed the delay to multiple business managers during FY2021–FY2023 and untimely documentation. No questioned costs were reported.",
    whatItEstablishes:
      "The official federal dataset establishes the repeat late-reporting finding, the auditor’s stated cause, the expenditure total, and absence of questioned costs.",
    whatItDoesNotEstablish:
      "Late reporting does not establish theft, fraud, or misconduct by any named administrator. The corrective-action text gives a different due-year than the finding narrative, so this entry uses the auditor’s finding date and does not resolve that discrepancy.",
    tags: ["Lodge Grass", "school district", "Single Audit", "late reporting", "repeat finding"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2025 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2023-06-GSAFAC-0000345755.",
      },
      {
        label: "Federal Audit Clearinghouse — 2025 findings data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2025-ay-findings.csv",
      ...
      },
      {
        ...
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter finding 2023-002; the narrative and corrective-action due-year wording are not identical.",
      },
    ],
  },
  {
    id: "BHA-2024-007",
    slug: "apsaalooke-housing-fy2021-cash-control-finding",
    title: "Apsaalooke Nation Housing Authority audit recorded repeat late filing and uninsured cash exposure",
    date: "2024-10-09",
    dateQualifier: "Federal Audit Clearinghouse acceptance date",
    year: 2024,
    place: "Crow Reservation / Federal Audit Clearinghouse",
    institution: "Apsaalooke Nation Housing Authority / Federal Audit Clearinghouse",
    officialType: "Tribal housing authority",
    theme: "Public money & audits",
    people: [],
    status: "Audit finding",
    publicationState: "Reviewed",
    summary:
      "Federal Audit Clearinghouse data for report 2021-09-GSAFAC-0000056379 records a repeat late-filing finding and an auditor finding that $1,216,251 in cash was uninsured and uncollateralized at September 30, 2021, creating a material weakness and potential loss exposure if the bank failed. No questioned costs were reported.",
    whatItEstablishes:
      "The official audit data establishes the repeat filing finding, the cash-balance condition and risk described by the auditor, material-weakness classification, and absence of questioned costs.",
    whatItDoesNotEstablish:
      "The finding does not say that money was stolen, missing, or lost, and it does not assign criminal or personal liability to any housing-authority employee or board member.",
    tags: ["Apsaalooke", "housing authority", "Single Audit", "cash controls", "material weakness", "late filing"],
    sources: [
      {
        label: "Federal Audit Clearinghouse — 2024 general data CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2024-ay-general.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "Filter report_id 2021-09-GSAFAC-0000056379.",
      },
      {
        label: "Federal Audit Clearinghouse — 2024 finding narratives CSV",
        url: "https://app.fac.gov/dissemination/public-data/gsa/audit-year/2024-ay-findings_text.csv",
        kind: "Official agency record",
        checkedOn: "2026-07-15",
        note: "See findings 2021-002 and 2021-003.",
      },
    ],
  },
  {
    id: "BHA-2000-001",
    slug: "jovanna-wallace-counterfeit-check-conviction",
    title: "Former Crow Tribe employee was convicted in a counterfeit tribal-check scheme",
    date: "2000-09-30",
    dateQualifier: "Disposition reported in the April–September 2000 OIG period; exact sentencing date not stated",
    year: 2000,
    place: "Crow Reservation / Montana",
    institution: "Crow Tribal Government",
    officialType: "Tribal employee",
    theme: "Public money & audits",
    people: ["Jovanna Wallace"],
    status: "Criminal conviction",
    publicationState: "Reviewed",
    summary:
      "The Interior Inspector General reported that former Crow Tribe employee Jovanna Wallace was convicted of bank fraud and possessing counterfeit checks after creating 35 counterfeit tribal checks exceeding $130,000 and successfully cashing more than $53,000. The reported sentence included 12 months of imprisonment, 36 months of supervised release, $53,760 restitution, community service, and a $200 assessment.",
    whatItEstablishes:
      "The official Inspector General report establishes the convictions, former employee status, conduct and amounts described by the agency, and the reported sentence and restitution.",
    whatItDoesNotEstablish:
      "The report does not identify Wallace’s tribal job title or exact sentencing date, and the individual conviction does not establish wrongdoing by the Crow Tribe or unrelated employees.",
    tags: ["Crow Tribe", "bank fraud", "counterfeit checks", "restitution", "Inspector General"],
    sources: [
      {
        label: "Department of the Interior OIG — October 2000 Semiannual Report",
        url: "https://www.doioig.gov/sites/default/files/2021-migration/Semiannual-OCT2000SAR.pdf",
        kind: "Inspector General report",
        checkedOn: "2026-07-15",
        note: "The report supplies the disposition within its April–September 2000 reporting period but does not state the exact sentencing day or job title.",
      },
    ],
  },
];
